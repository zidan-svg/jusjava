...
<body>
    <div class="container fade-in">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card text-center animate_animated animate_fadeInDown">
                    <div class="card-body">
                        ...
                        <a href="dashboard" class="btn btn-primary btn-lg mt-4 animate_animated animatepulse animate_infinite">
