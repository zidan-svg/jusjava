...
<head>
    ...
    <title>Kelola Produk - JavaJuice</title>
...
<body>
    ...
    <div class="container mt-5">
        <div class="header">
            <h1>Kelola Produk</h1>
            <p>Di sini Anda dapat menambah, mengedit, atau menghapus data produk.</p>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ route('products.create') }}" class="btn btn-success btn-custom">Tambah Produk</a>
                                ...
                                @forelse ($products as $product)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form onsubmit="return confirm('Apakah Anda yakin ingin menghapus?');" action="{{ route('products.destroy', $product->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
