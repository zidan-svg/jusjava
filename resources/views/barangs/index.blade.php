...
<head>
    ...
    <title>Kelola Barang - JavaJuice</title>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ route('barangs.create') }}" class="btn btn-success btn-custom">Tambah Barang</a>
                                ...
                                @forelse ($barangs as $barang)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ route('barangs.show', $barang->id) }}" class="btn btn-primary btn-sm">Lihat</a>
