...
<body style="background: lightgray">
    ...
    <div>
        <h3 class="text-center my-4">Tambahkan Barang Keluar</h3>
     </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{ route('barangkeluars.store') }}" method="POST" enctype="multipart/form-data">
                        
                            @csrf

                            <div class="form-group mb-3">
                                <label class="font-weight-bold">Nama barang</label>
                                <input type="text" class="form-control @error('Nama_barang') is-invalid @enderror" value="{{ old('Nama_barang') }}" name="Nama_barang" placeholder="Masukkan Nama barang keluar">
